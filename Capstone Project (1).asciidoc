...
[source, ipython3]
----
accidents_df['PERSONCOUNT'].unique()
----


+*Out[56]:*+
----array([ 2,  4,  3,  0,  5,  1,  6, 16,  8,  7, 11,  9, 12, 17, 26, 22, 10,
...
[source, ipython3]
----
y = PersonCountValue[PersonCountValue['SEVERITYCODE']) == 2, "Value_Counts"]
----
...
----
    ...
    <ipython-input-38-275a3e62247f> in <module>
    ----> 1 y = PersonCountValue[PersonCountValue['SEVERITYCODE'] == 2, "Value_Counts"]
